...
//    public static Checker checker = new Checker();
    ...
    public InventoryDetector() {
        ...
        MinecraftForge.EVENT_BUS.register(new InventoryDetectEventLoader());
        ModLoadingContext.get().registerConfig(ModConfig.Type.COMMON, Config.CLIENT_CONFIG, "inventory-detector_config.toml");
